      ...
      <section className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between py-20 lg:py-32 px-8 lg:px-16 gap-16">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
            <motion.div animate={floatingAnimation(0)}>
              <Image
                ...
                width={280}
                height={280}
                className="drop-shadow-2xl rotate-[-5deg]"
              />
            </motion.div>
          </div>
          ...
          {[
            ...
            >
              <Image
                ...
                width={110}
                height={110}
                className={`rounded-2xl shadow-lg rotate-[${img.rot}deg] border-2 border-white`}
              />
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <h1 className="text-5xl lg:text-7xl font-black text-gray-900 leading-[1.1]">
            Books are better <br />{" "}
            <span className="text-[#14919B]">when shared.</span>
          </h1>
          <p className="text-xl text-gray-500 font-medium max-w-md">
            The social platform for readers. Track your progress, earn levels,
            and challenge friends in the ultimate literary arena.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 font-medium">
              Everything you need to turn reading into an adventure.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all group">
              ...
              <p className="text-gray-500 leading-relaxed">
                Earn XP for every page you read. Level up your profile and
                unlock exclusive badges and titles.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all group">
              ...
              <p className="text-gray-500 leading-relaxed">
                Join book-specific communities. Contribute quotes, participate
                in discussions, and grow together.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all group">
              ...
              <p className="text-gray-500 leading-relaxed">
                Set reading goals and challenge your friends to real-time duels.
        ...
        <div className="max-w-5xl mx-auto bg-[#14919B] rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden shadow-2xl shadow-[#14919B]/30">
          ...
          <div className="relative z-10">
            ...
            <div className="flex justify-center">
              <Link
                href="/register"
                className="bg-white text-[#14919B] px-10 py-4 rounded-2xl font-black text-xl hover:scale-105 transition-transform shadow-xl"
              >
                Create Your Profile
              </Link>
            </div>
