...
import { evaluateDailyGoal, syncStreak, getUserStreakandGoal, adjustDailyGoal, getAchievementAllTime, challengeFriend, respondToChallenge, getUserFriendChallenges, getAchievedBadges } from "../../controllers/users/gamification.controller.js";
...
router.get('/daily-goal/all', authenticateToken, getAchievementAllTime);
