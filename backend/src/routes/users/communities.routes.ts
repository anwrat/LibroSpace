...
import {
  ...
  checkUserMembership,
  startDiscussion,
  getAllDiscussionsByCommunityId,
  ...
  removeMember,
  deleteADiscussion,
  deleteACommentfromDiscussion,
} from "../../controllers/users/communities.controller.js";
...
router.post("/check-existence", authenticateToken, checkCommunityExistence);
router.post(
  "/",
  authenticateToken,
  communityImgUpload.single("photo_url"),
...
//Comments
router.post(
  "/:community_id/discussions/:id/comments",
  authenticateToken,
...
router.delete(
  "/:community_id/discussions/:discussion_id/comments/:id",
  authenticateToken,
  deleteACommentfromDiscussion,
);
